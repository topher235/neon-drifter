...
@onready var music_check: CheckButton = $Panel/MarginContainer/VBoxContainer/MusicSetting/MusicCheckButton
@onready var sound_check: CheckButton = $Panel/MarginContainer/VBoxContainer/SoundSetting/SoundCheckButton
