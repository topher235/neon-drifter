...
NeonDrift is a mobile, top-down infinite runner game built with Godot 4.4. The player controls a circle using touch
input, navigating through a procedurally generated tunnel while avoiding obstacles and collecting items. The game
features a minimalist neon-highlighted aesthetic.
...
- **Dimensions**: segment_length (default 800), tunnel_width (default 300)
