...
var selected_cosmetic_id: String = "cyan_default"
...
func _initialize_cosmetics() -> void:
	...
	cyan_cosmetic.cosmetic_id = "cyan_default"
	...
	cyan_cosmetic.unlocked_by_default = true
	cyan_cosmetic.orb_cost = 0
	cosmetics["cyan_default"] = cyan_cosmetic
